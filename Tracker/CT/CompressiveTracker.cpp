...
void CompressiveTracker::HaarFeature(cv::Rect& _objectBox, int _numFeature)
...
*/
{
	features = vector<vector<cv::Rect>>(_numFeature, vector<cv::Rect>());
...
void CompressiveTracker::sampleRect(Mat& _image, cv::Rect& _objectBox, float _rInner, float _rOuter, int _maxSampleNum, vector<cv::Rect>& _sampleBox)
...
void CompressiveTracker::sampleRect(Mat& _image, cv::Rect& _objectBox, float _srw, vector<cv::Rect>& _sampleBox)
...
void CompressiveTracker::getFeatureValue(Mat& _imageIntegral, vector<cv::Rect>& _sampleBox, Mat& _sampleFeatureValue)
{
...
void CompressiveTracker::init(Mat& _frame, cv::Rect& _objectBox)
{
...
void CompressiveTracker::processFrame(Mat& _frame, cv::Rect& _objectBox, bool _update)
{
	// predict
	...
	// update
	if(_update) {
	    update(_frame, _objectBox);
	}
}

void CompressiveTracker::update(Mat &_frame, cv::Rect &_objectBox) {
