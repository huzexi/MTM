...
public:
	...
	Kernel* clone() override
	{
		Kernel* mirror = new LinearKernel(*this);
		return mirror;
	}
};
...
public:
	...
	Kernel* clone() override
	{
		Kernel* mirror = new GaussianKernel(*this);
		return mirror;
	}
...
public:
	...
	Kernel* clone() override
	{
		Kernel* mirror = new IntersectionKernel(*this);
		return mirror;
	}
};
...
public:
	...
	Kernel* clone() override
	{
		Kernel* mirror = new Chi2Kernel(*this);
		return mirror;
	}
};
...
public:
	...
	Kernel* clone() override
	{
		MultiKernel* mirror = new MultiKernel(*this);
		m_kernels.clear();
		for (Kernel* t:m_kernels)
		{
			mirror->m_kernels.push_back(t->clone());
		}
		return mirror;
	}
